        ...
        <section id="tutorial-wrap" class="tutorial-wrap" aria-hidden="true">
            <div class="tutorial-content">
                ...
                <div class="tutorial-actions">
                    <button type="button" class="tutorial-btn-play" id="btn-tutorial-play">Jugar</button>
                    <a href="#" class="tutorial-btn-repeat" id="btn-tutorial-repeat">Repetir tutorial</a>
                    <button type="button" class="tutorial-btn-skip" id="btn-tutorial-skip">Saltar</button>
                </div>
            </div>
        </section>
